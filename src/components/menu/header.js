                        ...
                        {openMenu && (
                          <div className='item-dropdown'>
                            <div className="dropdown" onClick={closeMenu}>
                              <NavLink to=" " onClick={()=> window.open("http://grey.on3-step.com", "_self")}>New Grey Scheme</NavLink>
                              <NavLink to=" " onClick={()=> window.open("http://retro.on3-step.com", "_self")}>New Retro Scheme</NavLink>
